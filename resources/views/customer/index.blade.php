...
<div class="table-responsive">
    <table class="table">
        ...
        <td>
        <a href="{{ route('customer.edit', 1) }}" class="btn btn-sm
        btn-primary">Edit</a>
        </td>
        </tr>
        <tr>
        ...
        <td>
        <a href="{{ route('customer.edit', 2) }}" class="btn btn-sm
        btn-primary">Edit</a>
    </td>
</tr>
<tr>
...
<td>
<a href="{{ route('customer.edit', 3) }}" class="btn btn-sm
btn-primary">Edit</a>
</td>
</tr>
<tr>
...
<td>
<a href="{{ route('customer.edit', 4) }}" class="btn btn-sm
btn-primary">Edit</a>
</td>
</tr>
<tr>
...
<td>
<a href="{{ route('customer.edit', 5) }}" class="btn btn-sm
btn-primary">Edit</a>
</td>
</tr>
</tbody>
